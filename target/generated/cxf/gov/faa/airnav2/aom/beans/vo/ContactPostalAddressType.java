...
/**
 * <p>Java class for ContactPostalAddressType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ContactPostalAddressType">
 *   &lt;complexContent>
...
@XmlType(name = "ContactPostalAddressType", propOrder = {
    "identifier",
    "stateCode",
    "countryCode",
    "addressTypeCode",
...
public class ContactPostalAddressType
    extends AbstractAuditType
{
    ...
    @XmlElementRef(name = "AddressTypeCode", namespace = "http://airnav2.faa.gov/aom/beans/vo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> addressTypeCode;
    @XmlElementRef(name = "AddressLine1", namespace = "http://airnav2.faa.gov/aom/beans/vo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> addressLine1;
    @XmlElementRef(name = "AddressLine2", namespace = "http://airnav2.faa.gov/aom/beans/vo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> addressLine2;
    @XmlElementRef(name = "ZipCode", namespace = "http://airnav2.faa.gov/aom/beans/vo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> zipCode;
    @XmlElementRef(name = "CityName", namespace = "http://airnav2.faa.gov/aom/beans/vo", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<String> getAddressTypeCode() {
     ...
     *     
     */
    public void setAddressTypeCode(JAXBElement<String> value) {
